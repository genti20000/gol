-- Add 5-minute slot holds and enforce one active booking per service/date/start_time.
...
CREATE UNIQUE INDEX IF NOT EXISTS bookings_service_date_start_unique
